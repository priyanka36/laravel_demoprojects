        ...
        <div class="br-pagetitle">
            <div class="br-pagebody">
                <div class="br-section-wrapper">
                    <h6 class="br-section-label">Rum</h6>

                    <form action="{{ route('backend.rumStore') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-layout form-layout-1">
                            ...
                            <div class="form-layout-footer">
                                ...
                                <a href="{{ route('backend.rumList') }}" class="btn btn-warning">Cancel</a>
