...
@section('main-content')
    ...
    <div class="br-mainpanel" id="app">
            ...
            <div class="br-pagebody">
                <div class="br-section-wrapper">
                    <div class="">
                        ...
                        <a href="{{ route('backend.whiskyCreate') }}" class="btn btn-success"> Add New</a>
                    ...
                    <div class="table-wrapper">
                        <table id="tableList" class="table display responsive nowrap datatable1">
                            ...
                            <tbody>
                            @foreach($whiskyListData as $whisky)
                                <tr>
                                    <td>{{$whiskyListIndex++}}</td>
                                    <td>{{$whisky->name}}</td>
                                    <td>{{$whisky->description}}</td>

                                    <td><img src="{{ asset('uploads/whisky-photos/'.$whisky->whisky_photo) }}" style="width: 150px"></td>
                                    ...
                                    <td width="200px">
                                        <a href="{{ route('backend.editWhiskyDetail',$whisky->id) }}"
                                           class="btn btn-sm shadow-1 btn-success" >Update
                                        </a>
                                        |
                                        <a href="#" @click.prevent='setWhiskyIdForDelete({{$whisky->id}})' class="btn btn-sm shadow-1 btn-warning whisky-delete"
                                           data-toggle="modal" data-target="#whisky-first-delete-model"> Delete</a>
                                    </td>
        ...
        <!-- Modal -->
        <div class="modal fade" id="whisky-first-delete-model" tabindex="-1" role="dialog"
...
@section('additional-js')
    ...
    <script src="{{ asset('vue-js-project-files/backend/whisky/code.js') }}"></script>
