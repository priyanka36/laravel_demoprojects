        ...
        <div class="br-pagetitle">
            <div class="br-pagebody">
                <div class="br-section-wrapper">
                    <h6 class="br-section-label">Vodka</h6>

                    <form action="{{ route('backend.vodkaStore') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-layout form-layout-1">
                            ...
                            <div class="form-layout-footer">
                                ...
                                <a href="{{ route('backend.vodkaList') }}" class="btn btn-warning">Cancel</a>
