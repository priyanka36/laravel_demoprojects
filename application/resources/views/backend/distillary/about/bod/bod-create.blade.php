        ...
        <div class="br-pagetitle">
            <div class="br-pagebody">
                <div class="br-section-wrapper">
                    ...
                    <form action="{{ route('backend.bodStore') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-layout form-layout-1">
                            <div class="row">
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="file" name="bodmember_photo"  class="form-control">
                                    @if($errors->first('bodmember_photo'))
                                        <div class="text-danger ">   {{$errors->first('bodmember_photo')  }} </div>
                                    @endif
                                </div>
                                <div class="col-4">
                                    <br>
