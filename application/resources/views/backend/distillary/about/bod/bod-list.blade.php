    ...
    <div class="br-mainpanel" id="app">
        <div class="br-pageheader">
            <nav class="breadcrumb pd-0 mg-0 tx-12">
                ...
                <span class="breadcrumb-item active">Board List </span>
                            ...
                            @foreach($bodListData as $bod)
                                <tr>
                                    ...
                                    <td width="200px">
                                        ...
                                        |
                                        <a href="#" @click.prevent='setBodIdForDelete({{$bod->id}})' class="btn btn-sm shadow-1 btn-warning bod-delete"
