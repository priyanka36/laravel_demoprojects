        ...
        <div class="br-pagetitle">
            <div class="br-pagebody">
                <div class="br-section-wrapper">
                    ...
                    <form action="{{ route('backend.careerStore') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-layout form-layout-1">
                            <div class="row">
                                ...
                                <div class="col-4">
                                    ...
                                    <textarea name="requirement" class="form-control "  required rows="3" cols="90"   name="requirement">{!! old('requirement') !!}
                 </textarea>
                                ...
                                <div class="col-4">
                                    ...
                                    <label class="form-control-label"> Desired Skills:</label>
                                     <textarea name="skills" class="form-control "  required rows="3" cols="90"   name="skills">{!! old('skills') !!}
                 </textarea>
